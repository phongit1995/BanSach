  ...
  load: function load(pdfDocument) {
    ...
    pdfDocument.getPageLabels().then(function (labels) {
      ...
      if (numLabels !== _this5.pagesCount) {
        console.error('The number of Page Labels does not match ' + 'the number of pages in the document.js.');
        return;
      }
...
var PDFSidebar = function () {
  ...
  _createClass(PDFSidebar, [{
    ...
    value: function _showUINotification(view) {
      ...
      this.l10n.get('toggle_sidebar_notification.title', null, 'Toggle Sidebar (document.js contains outline/attachments)').then(function (msg) {
    ...
    value: function updateUIState(state, previous, matchesCount) {
      ...
      switch (state) {
        ...
        case _pdf_find_controller.FindState.WRAPPED:
          if (previous) {
            findMsg = this.l10n.get('find_reached_top', null, 'Reached top of document.js, continued from bottom');
          } else {
            findMsg = this.l10n.get('find_reached_bottom', null, 'Reached end of document.js, continued from top');
          }
          break;
      }
